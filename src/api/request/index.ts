...
/** 路径 get 请求 */
export const pathArgGet = <Res = any, Params extends string = string>(url: string, otherConfigs?: Partial<Omit<RequestConfig, 'params' | 'data' | 'args'>>) => {
...
/** post 请求 */
export const post = <Res = any, Data = any>(url: string, otherConfigs?: Partial<Omit<RequestConfig<Data>, 'params'>> & { params?: any }) => {
